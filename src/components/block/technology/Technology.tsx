		...
		<Section otherStyle="technology" id={id}>
			<Container>
				...
				<p>
					...
					<a href="https://www.github.com/petrzabransky" className="link" target="_blank"> github.</a> Jakoukoli jinou technologii, kterou vyžívá Vaše firma, se rád a rychle doučím.
				</p>
			</Container>
		</Section>
	)
